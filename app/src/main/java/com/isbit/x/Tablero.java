...
public class Tablero extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.isbit.x.R.layout.activity_tablero);
...
//
        ...
        */
        ...
        Button button = (Button) findViewById(com.isbit.x.R.id.button_acceder);
        ...
        Log.i(TAG, "onActivityResult(requestCode="+requestCode+", resultCode, data="+data+")");
            if (result != null) {
                ...
                try {
                    ...
                    ds.save_key_value_pair( DS.secret_key, secret_key);
                    ds.save_key_value_pair( DS.url_host, url_host);
                    ds.save_key_value_pair( DS.url_schema, url_schema);
                    ds.close();
    ...
    public void initIsbit(final View rootView, final Activity activity){
        ...
        final Button access_button = (Button) findViewById(com.isbit.x.R.id.button_acceder);
